...
const R2160pExp
  = /(?<R2160P>2160p|4k[-_. ](?:UHD|HEVC|BD)|(?:UHD|HEVC|BD)[-_. ]4k|\b(4k)\b|COMPLETE.UHD|UHD.COMPLETE)/iu;
const R1080pExp = /(?<R1080P>1080(i|p)|1920x1080)(10bit)?/iu;
const R720pExp = /(?<R720P>720(i|p)|1280x720|960p)(10bit)?/iu;
const R576pExp = /(?<R576P>576(i|p))/iu;
const R540pExp = /(?<R540P>540(i|p))/iu;
const R480Exp = /(?<R480P>480(i|p)|640x480|848x480)/iu;
