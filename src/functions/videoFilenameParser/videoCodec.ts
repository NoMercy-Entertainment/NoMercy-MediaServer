const x265Exp = /(?<x265>x265)/iu;
const h265Exp = /(?<h265>h265)/iu;
const x264Exp = /(?<x264>x264)/iu;
const h264Exp = /(?<h264>h264)/iu;
const WMVExp = /(?<wmv>WMV)/iu;
const xvidhdExp = /(?<xvidhd>XvidHD)/iu;
const xvidExp = /(?<xvid>X-?vid)/iu;
const divxExp = /(?<divx>divx)/iu;
const hevcExp = /(?<hevc>HEVC)/iu;
const dvdrExp = /(?<dvdr>DVDR)\b/iu;
