/*
  ...
  - You are about to drop the column `season` on the `File` table. All the data in the column will be lost.
  - Added the required column `seasonNumber` to the `File` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_File" ("airDate", "atimeMs", "birthtimeMs", "chapters", "createdAt", "ctimeMs", "edition", "ep_folder", "episodeId", "episodeNumber", "extension", "ffprobe", "folder", "fullSeason", "gid", "group", "id", "isMultiSeason", "isPartialSeason", "isSeasonExtra", "isSpecial", "isTv", "languages", "libraryId", "mode", "movieId", "mtimeMs", "name", "nlink", "path", "revision", "seasonPart", "size", "sources", "title", "type", "uid", "updatedAt", "year") SELECT "airDate", "atimeMs", "birthtimeMs", "chapters", "createdAt", "ctimeMs", "edition", "ep_folder", "episodeId", "episodeNumber", "extension", "ffprobe", "folder", "fullSeason", "gid", "group", "id", "isMultiSeason", "isPartialSeason", "isSeasonExtra", "isSpecial", "isTv", "languages", "libraryId", "mode", "movieId", "mtimeMs", "name", "nlink", "path", "revision", "seasonPart", "size", "sources", "title", "type", "uid", "updatedAt", "year" FROM "File";
DROP TABLE "File";
